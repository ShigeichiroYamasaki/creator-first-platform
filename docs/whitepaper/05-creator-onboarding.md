...
公開テストネットでは、仮名プロフィールを現在のTabへ保存し、ユーザが明示接続したPolygon Amoy ウォレットから音楽クリエーターコミットメントと作品の権利自己申告コミットメントを登録する。公開チェーンへ実名、作品名、音源、契約書、権利資料、税務情報または秘密情報は保存しない。
...
[テスト音楽クリエーター利用フロー](/demo/creator-workspace)ではこの分離を合成データとPolygon Amoyで確認できる。
