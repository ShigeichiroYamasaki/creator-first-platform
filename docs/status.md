...
| アプリケーション | ローカルVertical Slice | [Navidrome Docker Server](/demo/local-streaming)、[Streaming Gateway Mock](/demo/local-gateway)、Alias限定Test User登録、Vue Player PWA、SIWE／EIP-712、Playback Evidence | 本番Authenticator、Navidrome非公開Network、Read Model、Testnet Contract、Security Review |
