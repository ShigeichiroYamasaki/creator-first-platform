...
| DAOガバナンス | 二院制ガバナー／デモポリシーはEthereum Sepoliaへ公開デプロイ済み、CFP識別子・改訂結合を含む拡張とCFP記録ゲートはローカル検証のみ | [二院制議会・二次投票・コントラクト変更手続](/governance/)、[音楽クリエータ院議会](/demo/creator-house)、[ユーザ院議会](/demo/user-house)、[CFP文書・議事録管理](/proposals/record-management)、[二院制ガバナーとデモポリシーの公開アドレス](/demo/testnet-contracts#public-deployment)、[CFP-0002](/proposals/CFP-0002-early-supporter-one-year-rule)、会期別同量投票クレジット、投票前適合性審査、両院議事録・議決・論点・証拠索引、両院別集計、レビュー、P2タイムロック、完全一致デプロイの自動テスト | CFP識別子・改訂結合を含む拡張のSepolia再デプロイと公開マニフェスト更新、重大論点の解決、正式な三憲章、実在する審査者・議員・熟議、確認済み議事録、検証可能な抽選、本人性・重複防止、秘密投票、異議申立て、理由付き差し戻し、本番権限移管、監査 |
