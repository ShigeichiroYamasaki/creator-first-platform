...
| DAOガバナンス | テストネット実装・公開デプロイ前 | [二院制議会・二次投票・コントラクト変更手続](/governance/)、[ウォレット対応デモ画面](/demo/governance)、会期別同量投票クレジット、両院別集計、レビュー、タイムロック、緊急取消しのコントラクトと自動テスト | Sepoliaデプロイ、会期・議員・提案登録、検証可能な抽選、本人性・重複防止、秘密投票、異議申立て、理由付き差し戻し、本番権限移管、監査 |
