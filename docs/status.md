...
| DAOガバナンス | 二院制ガバナー／デモポリシーはEthereum Sepoliaへ公開デプロイ済み、CFP-0002拡張はローカル検証のみ | [二院制議会・二次投票・コントラクト変更手続](/governance/)、[ウォレット対応デモ画面](/demo/governance)、[二院制ガバナーとデモポリシーの公開アドレス](/demo/testnet-contracts#public-deployment)、[CFP-0002](/proposals/CFP-0002-early-supporter-one-year-rule)、会期別同量投票クレジット、投票前適合性審査、両院熟議証拠、両院別集計、レビュー、P2タイムロック、完全一致デプロイの自動テスト | CFP-0002拡張のSepolia再デプロイと公開マニフェスト更新、実在する審査者・議員・熟議、検証可能な抽選、本人性・重複防止、秘密投票、異議申立て、理由付き差し戻し、本番権限移管、監査 |
