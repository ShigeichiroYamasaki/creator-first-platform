...
二院制議会と二次投票は、[テストネット版ガバナンスデモ](/demo/governance)で提案状態、両院別集計、議員の投票クレジットを確認できます。Sepoliaのガバナンスアドレスが公開マニフェストへ登録されるまでは、画面の書込み操作を停止します。
...
| テストネットガバナンス | [二院制・二次投票・タイムロック画面](/demo/governance)とコントラクトを実装。Sepoliaデプロイ、会期・議員・提案登録、抽選・秘密投票・異議申立ては未完了 |
