...
財布アプリは、実験の操作を本人が行ったことを確認するために使います。本デモでは、オレンジ色のキツネが目印の **MetaMask（メタマスク）** を使用します。

[財布アプリの準備を画像付きで確認する →](/demo/metamask-amoy-setup)
...
どちらを選んでも、実名、実在作品、未公開音源、本番用の財布は使用しません。画面内で「練習用」「テスト用」と表示されたものだけを使います。
