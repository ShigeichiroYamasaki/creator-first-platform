...
export function loadConfig(environment = process.env) {
  ...
  return {
    ...
    applicationStatusPublicUrl: environment.GATEWAY_APPLICATION_STATUS_PUBLIC_URL ?? `${publicUrl.origin}/creator-first-platform/demo/participant-application-status`,
    mailMode,
